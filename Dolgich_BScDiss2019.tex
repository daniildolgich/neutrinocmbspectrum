...
\maketitle
\abstract{We studied the Cosmic Microwave Background radiation (CMB) in order to better understand the lesser studied portions of the CMB Power Spectrum. To facilitate this, I created my own CMB simulator with Python 2.7, using Jupyter Notebook as the compiler and Github to commit and push my work.
\paragraph{}
